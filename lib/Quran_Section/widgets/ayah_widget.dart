    ...
    return InkWell(
      ...
      child: Container(
        ...
        color: _isHighlighted
            ...
            : Colors.transparent,
        child: Text(
          "${widget.ayah.text.replaceFirst(RegExp(r'^بِسۡمِ ٱللَّهِ ٱلرَّحۡمَٰنِ ٱلرَّحِيمِ'), '').trim()} ﴿${widget.ayah.numberInSurah}﴾ ",
                        ...
                        children: [
                          ...
                          ListTile(
                            ...
                            onTap: () async {
                              ...
                              try {
                                final String tafsir = await TafsirService()
                                    .getTafsir(widget.ayah.number);
